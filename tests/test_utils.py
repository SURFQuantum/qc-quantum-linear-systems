...
class TestUtils(unittest.TestCase):
    ...
    def test_make_matrix_hermitian(self) -> None:
    ...
    def test_expand_b_vector(self) -> None:
    ...
    def test_extract_x_from_expanded(self) -> None:
    ...
    def test_extract_hhl_solution_vector_from_state_vector(self) -> None:
